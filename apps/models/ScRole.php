...
//    }
    ...
    public static function getControllers(){
        return array(
            'setting' => array('backendlanguage','backendrole','backendconfig','backendpage','backendbanner','backendemailtemplate','backendlocation'),
            'content' => array('backendtype','backendarticle','backendoffice','backendcontactoption','backendcareer','backendcountry','backendarea','backendnewspaper','newspaperarticle'),
            'translate'  => array('backendtranslate','backendtooltranslate'),
        );
    }
}
